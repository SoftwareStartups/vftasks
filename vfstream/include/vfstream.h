 ...
 *
 * Parameter:
 *   wport - A pointer to the write port through which the reader is connected
 *           to the channel.
 */
 ...
 *
 * Parameter:
 *   rport - A pointer to the read port through which the reader is connected
 *           to the channel.
 */
 ...
 *   token_size - The token size.
 *   ctl_space  - A pointer to the memory-management implementation that is to
 *                be used to allocate memory for the channel's control
 *                structure.
 *   buf_space  - A pointer to the memory-management implementation that is to
 ...
 *
 * Parameters:
 *     chan       - A pointer to the FIFO channel.
 *     port_space - A pointer to the memory-management implementation that is
 ...
 *
 * Parameters:
 *   wport      - A pointer to the port.
 *   port_space - A pointer to the memory-management implementation that is to
 *                be used to deallocate the memory that was allocated for the
 *                port.
 */
 ...
 * Parameters:
 *   chan           - A pointer to the channel.
 *   suspend_writer - A pointer to the function that is to be called when a
 *                    writer connected to the channel might want to be
 *                    suspended.
 *   resume_writer  - A pointer to the function that is to be called when a
 *                    writer connected to the channel might want to be resumed.
 *   suspend_reader - A pointer to the function that is to be called when a
 *                    reader connected to the channel might want to be
 *                    suspended.
 *   resume_reader  - A pointer to the function that is to be called when a
 ...
 * Parameters:
 *   chan     - A pointer to the channel.
 *   min_room - The new low-water mark.
 *
 * Returns:
 ...
 * Parameters:
 *   chan     - A pointer to the channel.
 *   min_data - The new high-water mark. 
 *   
 * Returns:
 ...
 * Parameters:
 *   chan - A pointer to the channel.
 *   info - A pointer to the application-specific data.
 */
 ...
 *
 * Parameter:
 *   wport - A pointer to the write port.
 */
 ...
 *
 * Parameter:
 *   rport - A pointer to the read port.
 */
